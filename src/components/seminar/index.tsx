...
function Seminar(props: Props): JSX.Element {
  ...
  return (
    <div className="relative flex space-x-6 py-6 px-5 xl:static cursor-pointer sm:hover:bg-indigo-50 active:bg-indigo-50">
      ...
      <div className="flex-grow">
        ...
        <dl className="mt-2 flex flex-col text-gray-500 xl:flex-row">
          ...
          <div className="mt-2 flex items-center space-x-2 xl:mt-0 xl:ml-3.5 xl:border-l xl:border-gray-400 xl:border-opacity-50 xl:pl-3.5">
            <dt>
